...
export default function LoginPage() {
    ...
    const { signIn, signInWithGoogle, isCloudEnabled } = useAuth();
        ...
        <div className="min-h-screen flex" style={{ background: 'var(--color-cream)' }}>
            ...
            >
                <div>
                    ...
                    <p className="mt-2 text-lg" style={{ color: 'var(--color-gold-light)' }}>
                ...
                <div className="space-y-8">
                    ...
                    <div className="flex items-center gap-6">
                        {['Plan intelligently', 'Track habits', 'Achieve more'].map(
                            (feature, index) => (
                ...
                <div className="w-full max-w-md">
                    ...
                    >
                        <div className="text-center mb-8">
                            ...
                            <p className="mt-2" style={{ color: 'var(--color-slate)' }}>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    boxShadow: isLoading
                                        ? 'none'
                                        : '0 4px 16px rgba(184, 151, 107, 0.4)',
