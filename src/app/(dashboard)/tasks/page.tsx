            ...
            if (daysDiff < 0) {
                ...
                return (
                    <span
                        className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium"
                        style={{
                            background: 'rgba(201, 150, 126, 0.15)',
                            color: 'var(--color-meal)',
                        }}
                    >
                        Due Today
        ...
        return (
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                >
                    ...
                    />
                    <div
                        className="h-4 w-72 rounded mt-2"
                        style={{ background: 'var(--color-ivory)' }}
                    />
                </div>
                {/* Skeleton Filters */}
        ...
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            >
                <div>
                    ...
                    <p style={{ color: 'var(--color-slate)', lineHeight: 1.6 }}>
                        Manage your tasks that will be automatically scheduled into your daily
                        plans.
                    </p>
                </div>
                <button
                    ...
                    {[
                        ...
                        <button
                            ...
                            style={{
                                ...
                                color:
                                    filter === key ? 'var(--color-charcoal)' : 'var(--color-mist)',
                        ...
                        >
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div
                                        className="flex flex-wrap items-center gap-4 text-sm ml-11"
                                ...
                                <div className="flex gap-1 flex-shrink-0 self-end sm:self-start sm:ml-2">
                                    <button
                                    ...
                                    <button
                                        ...
                                        aria-label={
                                            task.isActive ? 'Deactivate task' : 'Activate task'
                                        }
                                    >
                                        {task.isActive ? (
                                            <svg
            ...
            {filteredTasks.length === 0 && (
                ...
                >
                    ...
                    <p className="mb-8" style={{ color: 'var(--color-slate)' }}>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={e =>
                                                setEditingTask(prev => ({
                                                    ...prev,
                                                    energyLevel: e.target
                                                        .value as Task['energyLevel'],
                                                }))
                                            }
                                            className="w-full px-4 py-3 rounded-lg text-sm focus:outline-none"
                                            style={{
                                            ...
                                            onChange={e =>
                                                setEditingTask(prev => ({
                                                    ...
                                                    timeWindowPreference:
                                                        (e.target
                                                            .value as Task['timeWindowPreference']) ||
                                                        undefined,
                                                }))
                                            }
                                            className="w-full px-4 py-3 rounded-lg text-sm focus:outline-none"
