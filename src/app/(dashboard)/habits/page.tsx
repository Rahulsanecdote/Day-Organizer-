            ...
            >
                <div>
                    ...
                    <p style={{ color: 'var(--color-slate)', lineHeight: 1.6 }}>
                        Manage your habits that will be automatically scheduled into your daily
                        plans.
                    </p>
                </div>
                <button
                            ...
                            <div className="flex justify-between items-start mb-5">
                                ...
                                <div className="flex gap-1">
                                    <button
                                        ...
                                        aria-label={
                                            habit.isActive ? 'Deactivate habit' : 'Activate habit'
                                        }
                                    >
                                        {habit.isActive ? (
                                            <svg
                    ...
                    >
                        <div className="p-8">
                            ...
                            <div className="space-y-6">
                                            ...
                                            {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(
                                                (day, index) => (
                                                    <button
                                                        ...
                                                        style={{
                                                            background:
                                                                editingHabit.specificDays?.includes(
                                                                    index
                                                                )
                                                                    ? 'var(--color-gold)'
                                                                    : 'var(--color-ivory)',
                                                            color: editingHabit.specificDays?.includes(
                                                                index
                                                            )
                                                                ? 'white'
                                                                : 'var(--color-stone)',
                                ...
                                <div>
                                    <label
                                        htmlFor="habit-preferred-window"
                                        className="block text-xs uppercase tracking-wider mb-2"
                                        style={{ color: 'var(--color-mist)' }}
                                    >
                                    ...
                                    <select
                                        ...
                                        onChange={e =>
                                            setEditingHabit(prev => ({
                                                ...
                                                preferredTimeWindow:
                                                    (e.target
                                                        .value as Habit['preferredTimeWindow']) ||
                                                    undefined,
                                            }))
                                        }
                                        className="w-full px-4 py-3 rounded-lg text-sm focus:outline-none"
