...
export default function OnboardingPage() {
    ...
    const handleClearAllData = async () => {
        if (
            confirm(
                'Are you sure you want to clear ALL data? This will delete all habits, tasks, and history. This cannot be undone!'
            )
        ) {
            if (
                confirm(
                    'This action will permanently delete all your data. Type "DELETE" to confirm.'
                )
            ) {
        ...
        return (
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    />
                    <p className="mt-4 text-lg" style={{ color: 'var(--color-slate)' }}>
                        Loading preferences...
                    </p>
                </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            onChange={e =>
                                setPreferences(prev =>
                                    prev ? { ...prev, defaultSleepStart: e.target.value } : null
                                )
                            }
                            disabled={!isEditing}
                            className="w-full px-4 py-3 rounded-lg text-sm focus:outline-none disabled:opacity-60"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={e =>
                                setPreferences(prev =>
                                    prev ? { ...prev, defaultSleepEnd: e.target.value } : null
                                )
                            }
                            disabled={!isEditing}
                            className="w-full px-4 py-3 rounded-lg text-sm focus:outline-none disabled:opacity-60"
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            onChange={e =>
                                setPreferences(prev =>
                                    prev
                                        ? { ...prev, defaultBuffers: parseInt(e.target.value) }
                                        : null
                                )
                            }
                            disabled={!isEditing}
                    ...
                    <div>
                        <label
                            htmlFor="defaultDowntimeProtection"
                            className="block text-xs uppercase tracking-wider mb-2"
                            style={labelStyle}
                        >
                            ...
                            onChange={e =>
                                setPreferences(prev =>
                                    prev
                                        ? {
                                              ...prev,
                                              defaultDowntimeProtection: parseInt(e.target.value),
                                          }
                                        : null
                                )
                            }
                                            ...
                                            setPreferences(prev =>
                                                prev
                                                    ? {
                                                          ...
                                                          gymSettings: {
                                                              ...prev.gymSettings,
                                                              preferredWindow: e.target
                                                                  .value as GymSettings['preferredWindow'],
                                                          },
                                                      }
                                                    : null
                                            )
                ...
                <div className="space-y-6">
                    ...
                    {preferences.notifications.enabled && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label
                                    htmlFor="notifications-reminder-minutes"
                                    className="block text-xs uppercase tracking-wider mb-2"
                                    style={labelStyle}
                                >
                            ...
                            <div>
                                <label
                                    htmlFor="notifications-completion-check"
                                    className="block text-xs uppercase tracking-wider mb-2"
                                    style={labelStyle}
                                >
                                        ...
                                        setPreferences(prev =>
                                            prev
                                                ? {
                                                      ...
                                                      notifications: {
                                                          ...prev.notifications,
                                                          completionCheckMinutes: parseInt(
                                                              e.target.value
                                                          ),
                                                      },
                                                  }
                ...
                <div className="space-y-4">
                    <div className="flex flex-wrap gap-4">
                        <button
                            ...
                            style={{
                                background:
                                    'linear-gradient(135deg, var(--color-work) 0%, #5A8A8B 100%)',
                                color: 'white',
                        ...
                        <button
                            ...
                            style={{
                                background:
                                    'linear-gradient(135deg, var(--color-task) 0%, #A88F50 100%)',
                                color: 'white',
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm" style={{ color: 'var(--color-slate)' }}>
                                    Always export your data before making major changes or clearing
                                    data.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div
                                    className="p-4 rounded-lg"
                                    style={{
                                        background: 'rgba(201, 100, 100, 0.1)',
                                        border: '1px solid rgba(201, 100, 100, 0.2)',
                                    }}
                                >
                                    <div className="flex items-start">
                                        <span style={{ color: '#c96464' }} className="mr-3">
                                            ⚠️
                                        </span>
                                        <div>
                                            <h4
                                            ...
                                            >
                                                Importing data will merge with existing data. This
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        boxShadow: importData.trim()
                                            ? '0 2px 8px rgba(139, 159, 130, 0.3)'
                                            : 'none',
                                    }}
                                >
                                    Import Data
