                    ...
                    >
                        <div className="relative z-10 text-white space-y-4">
                            ...
                            <p className="text-indigo-100">
                                Take 2 minutes to set your intentions, schedule tasks, and optimize
                                your energy.
                            </p>
                            <div className="pt-4">
...
function QuickLink({ href, icon, label }: { href: string; icon: React.ReactNode; label: string }) {
    return (
        <a
            href={href}
            className="flex flex-col items-center justify-center gap-2 p-4 rounded-xl transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800"
